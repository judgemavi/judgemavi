(() => {
  const shared =
    window.__particleEffectState || (window.__particleEffectState = {});
  ...
  function resolveCanvasContext() {
    const nextCanvas = document.getElementById('particle-canvas');
